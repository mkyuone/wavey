...
const advancedSoundButton = document.querySelector("#advancedSoundButton");
const advancedSoundPanel = document.querySelector("#advancedSoundPanel");
const advancedSoundHandle = document.querySelector("[data-advanced-sound-handle]");
const advancedSoundMinimize = document.querySelector("#advancedSoundMinimize");
const advancedSoundClose = document.querySelector("#advancedSoundClose");
const advancedSoundPad = document.querySelector("#advancedSoundPad");
const advancedSoundDot = document.querySelector("#advancedSoundDot");
const advancedSpeedValue = document.querySelector("#advancedSpeedValue");
const advancedPitchValue = document.querySelector("#advancedPitchValue");
const advancedSoundReset = document.querySelector("#advancedSoundReset");
const advancedSoundChip = document.querySelector("#advancedSoundChip");
const advancedSoundChipValue = document.querySelector("#advancedSoundChipValue");
const advancedSoundUnsupported = document.querySelector("#advancedSoundUnsupported");
...
const translations = {
  en: {
    ...
    speed: "Speed",
    pitch: "Pitch",
    advancedSoundControls: "Advanced sound controls",
    minimizeAdvancedSoundControls: "Minimize advanced sound controls",
    closeAdvancedSoundControls: "Close advanced sound controls",
    soundControlPad: "Speed and pitch pad",
    soundControlDot: "Speed and pitch position",
    resetSoundControls: "Reset",
    advancedSoundUnsupported: "Pitch controls are not supported in this browser.",
    soundTouchLicense: "SoundTouchJS Audio Worklet",
    soundTouchLicenseSummary: "SoundTouchJS Audio Worklet is bundled locally for pitch and tempo controls and is licensed under the GNU Lesser General Public License, Version 2.1.",
  ...
  es: {
    ...
    speed: "Velocidad",
    pitch: "Tono",
    advancedSoundControls: "Controles de sonido avanzados",
    minimizeAdvancedSoundControls: "Minimizar controles de sonido avanzados",
    closeAdvancedSoundControls: "Cerrar controles de sonido avanzados",
    soundControlPad: "Panel de velocidad y tono",
    soundControlDot: "Posición de velocidad y tono",
    resetSoundControls: "Restablecer",
    advancedSoundUnsupported: "Los controles de tono no son compatibles con este navegador.",
    soundTouchLicense: "SoundTouchJS Audio Worklet",
    soundTouchLicenseSummary: "SoundTouchJS Audio Worklet se incluye localmente para controles de tono y tempo y está bajo la GNU Lesser General Public License, versión 2.1.",
  ...
  fr: {
    ...
    speed: "Vitesse",
    pitch: "Hauteur",
    advancedSoundControls: "Commandes audio avancées",
    minimizeAdvancedSoundControls: "Réduire les commandes audio avancées",
    closeAdvancedSoundControls: "Fermer les commandes audio avancées",
    soundControlPad: "Pavé vitesse et hauteur",
    soundControlDot: "Position vitesse et hauteur",
    resetSoundControls: "Réinitialiser",
    advancedSoundUnsupported: "Les commandes de hauteur ne sont pas prises en charge par ce navigateur.",
    soundTouchLicense: "SoundTouchJS Audio Worklet",
    soundTouchLicenseSummary: "SoundTouchJS Audio Worklet est intégré localement pour les commandes de hauteur et de tempo, sous licence GNU Lesser General Public License, version 2.1.",
  ...
  de: {
    ...
    speed: "Tempo",
    pitch: "Tonhöhe",
    advancedSoundControls: "Erweiterte Klangsteuerung",
    minimizeAdvancedSoundControls: "Erweiterte Klangsteuerung minimieren",
    closeAdvancedSoundControls: "Erweiterte Klangsteuerung schließen",
    soundControlPad: "Tempo- und Tonhöhenfeld",
    soundControlDot: "Tempo- und Tonhöhenposition",
    resetSoundControls: "Zurücksetzen",
    advancedSoundUnsupported: "Tonhöhensteuerung wird in diesem Browser nicht unterstützt.",
    soundTouchLicense: "SoundTouchJS Audio Worklet",
    soundTouchLicenseSummary: "SoundTouchJS Audio Worklet wird lokal für Tonhöhen- und Temporegelung gebündelt und ist unter der GNU Lesser General Public License, Version 2.1, lizenziert.",
  ...
  "pt-BR": {
    ...
    speed: "Velocidade",
    pitch: "Tom",
    advancedSoundControls: "Controles avançados de som",
    minimizeAdvancedSoundControls: "Minimizar controles avançados de som",
    closeAdvancedSoundControls: "Fechar controles avançados de som",
    soundControlPad: "Painel de velocidade e tom",
    soundControlDot: "Posição de velocidade e tom",
    resetSoundControls: "Redefinir",
    advancedSoundUnsupported: "Os controles de tom não são compatíveis com este navegador.",
    soundTouchLicense: "SoundTouchJS Audio Worklet",
    soundTouchLicenseSummary: "SoundTouchJS Audio Worklet é incluído localmente para controles de tom e tempo e licenciado sob a GNU Lesser General Public License, versão 2.1.",
  ...
  ru: {
    ...
    speed: "Скорость",
    pitch: "Тон",
    advancedSoundControls: "Расширенные настройки звука",
    minimizeAdvancedSoundControls: "Свернуть расширенные настройки звука",
    closeAdvancedSoundControls: "Закрыть расширенные настройки звука",
    soundControlPad: "Панель скорости и тона",
    soundControlDot: "Положение скорости и тона",
    resetSoundControls: "Сбросить",
    advancedSoundUnsupported: "Управление тоном не поддерживается в этом браузере.",
    soundTouchLicense: "SoundTouchJS Audio Worklet",
    soundTouchLicenseSummary: "SoundTouchJS Audio Worklet встроен локально для управления тоном и темпом и распространяется по лицензии GNU Lesser General Public License, версия 2.1.",
  ...
  hi: {
    ...
    speed: "स्पीड",
    pitch: "पिच",
    advancedSoundControls: "उन्नत ध्वनि नियंत्रण",
    minimizeAdvancedSoundControls: "उन्नत ध्वनि नियंत्रण छोटा करें",
    closeAdvancedSoundControls: "उन्नत ध्वनि नियंत्रण बंद करें",
    soundControlPad: "स्पीड और पिच पैड",
    soundControlDot: "स्पीड और पिच स्थिति",
    resetSoundControls: "रीसेट",
    advancedSoundUnsupported: "इस ब्राउज़र में पिच नियंत्रण समर्थित नहीं हैं।",
    soundTouchLicense: "SoundTouchJS Audio Worklet",
    soundTouchLicenseSummary: "SoundTouchJS Audio Worklet को पिच और टेम्पो नियंत्रणों के लिए स्थानीय रूप से शामिल किया गया है और यह GNU Lesser General Public License, Version 2.1 के तहत लाइसेंस प्राप्त है।",
  ...
  ja: {
    ...
    speed: "速度",
    pitch: "ピッチ",
    advancedSoundControls: "詳細サウンドコントロール",
    minimizeAdvancedSoundControls: "詳細サウンドコントロールを最小化",
    closeAdvancedSoundControls: "詳細サウンドコントロールを閉じる",
    soundControlPad: "速度とピッチのパッド",
    soundControlDot: "速度とピッチの位置",
    resetSoundControls: "リセット",
    advancedSoundUnsupported: "このブラウザではピッチコントロールを利用できません。",
    soundTouchLicense: "SoundTouchJS Audio Worklet",
    soundTouchLicenseSummary: "SoundTouchJS Audio Worklet はピッチとテンポのコントロール用にローカルに同梱され、GNU Lesser General Public License, Version 2.1 のもとでライセンスされています。",
  ...
  ko: {
    ...
    speed: "속도",
    pitch: "피치",
    advancedSoundControls: "고급 사운드 컨트롤",
    minimizeAdvancedSoundControls: "고급 사운드 컨트롤 최소화",
    closeAdvancedSoundControls: "고급 사운드 컨트롤 닫기",
    soundControlPad: "속도 및 피치 패드",
    soundControlDot: "속도 및 피치 위치",
    resetSoundControls: "재설정",
    advancedSoundUnsupported: "이 브라우저에서는 피치 컨트롤이 지원되지 않습니다.",
    soundTouchLicense: "SoundTouchJS Audio Worklet",
    soundTouchLicenseSummary: "SoundTouchJS Audio Worklet은 피치 및 템포 컨트롤을 위해 로컬로 번들되며 GNU Lesser General Public License, Version 2.1에 따라 라이선스됩니다.",
  ...
  "zh-CN": {
    ...
    speed: "速度",
    pitch: "音高",
    advancedSoundControls: "高级声音控制",
    minimizeAdvancedSoundControls: "最小化高级声音控制",
    closeAdvancedSoundControls: "关闭高级声音控制",
    soundControlPad: "速度和音高面板",
    soundControlDot: "速度和音高位置",
    resetSoundControls: "重置",
    advancedSoundUnsupported: "此浏览器不支持音高控制。",
    soundTouchLicense: "SoundTouchJS Audio Worklet",
    soundTouchLicenseSummary: "SoundTouchJS Audio Worklet 已本地打包，用于音高和节奏控制，并根据 GNU Lesser General Public License 2.1 版授权。",
  ...
  "zh-TW": {
    ...
    speed: "速度",
    pitch: "音高",
    advancedSoundControls: "進階聲音控制",
    minimizeAdvancedSoundControls: "最小化進階聲音控制",
    closeAdvancedSoundControls: "關閉進階聲音控制",
    soundControlPad: "速度與音高控制板",
    soundControlDot: "速度與音高位置",
    resetSoundControls: "重設",
    advancedSoundUnsupported: "此瀏覽器不支援音高控制。",
    soundTouchLicense: "SoundTouchJS Audio Worklet",
    soundTouchLicenseSummary: "SoundTouchJS Audio Worklet 已本地打包，用於音高與節奏控制，並依 GNU Lesser General Public License 2.1 版授權。",
...
const state = {
  ...
  advancedSoundMinimized: false,
  advancedSoundPanelX: null,
  advancedSoundPanelY: null,
  advancedSoundDrag: null,
  advancedSoundPadDrag: false,
...
const SOUNDTOUCH_PROCESSOR_URL = "./vendor/soundtouchjs-audio-worklet/soundtouch-processor.js";
const SOUNDTOUCH_PROCESSOR_NAME = "soundtouch-processor";
const PITCH_MIN_SEMITONES = -12;
